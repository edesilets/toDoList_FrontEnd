...
/***/ function(module, exports, __webpack_require__) {
	...
	var uiAction = __webpack_require__(29);

	// handlebars template require below
	var navbarTemplate = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var uiSign = __webpack_require__(6);
	var logicSign = __webpack_require__(7);

	var successMessage = function successMessage(data) {
	  console.log(data);
	};
	var failMessage = function failMessage(data) {
	  console.error(data);
	};

	var signUp = function signUp(event) {
	  event.preventDefault(); // Stops page Reload
	  var item = new FormData(event.target); // object containing the FormData
	  $.ajax({
	  ...
	  }).done(uiSign.upSuccessful()).fail(uiSign.upFail());
	};
	...
	var signOut = function signOut(event) {
	  ...
	  }).done(uiSign.outSuccessful()).fail(uiSign.outFail());
	};

	var chPass = function chPass(event) {
	  event.preventDefault(); // Stops page Reload
	  var item = new FormData(event.target); // object containing the FormData
	  $.ajax({
	    ...
	    processData: false, // Needed for FormData This is because item
	    data: item // item is referancing the new object called 'item'.
	  }).done(uiSign.inChangePwSuccessful()).fail(uiSign.inChangePwFail());
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var clearLoginFields = function clearLoginFields() {
	  $('#inputPassword').val('');
	  $('#inputEmail').val('');
	  $('.log-text').text('');
	};

	var logInSuccessful = function logInSuccessful() {
	...
	////----------SIGN UP----------////
	var clearSignUpFields = function clearSignUpFields() {
	  $('#reginputEmail').val('');
	...
	////----------CHANGE PASSWORD----------////
	var clearChangePwFields = function clearChangePwFields() {
	  $('#chInputPw').val('');
	  $('#chInputPwConf').val('');
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var env = __webpack_require__(5);
	var todo = __webpack_require__(8);
	...
	var logInSuccessful = function logInSuccessful(data) {
	  ...
	  var renderLists = function renderLists(lists) {
	    var listsTemplate = __webpack_require__(9);
	    $('#sel-list').append(listsTemplate({ lists: lists }));
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getItems = function getItems(id, onSuccess, onFailure) {
	  $.ajax({
	...
	var deleteItem = function deleteItem(id, onSuccess, onFailure) {
	  $.ajax({
	...
	var getLists = function getLists(onSuccess, onFailure) {
	  $.ajax({
	...
	var addItemToList = function addItemToList(id, onSuccess, onFailure) {
	  event.preventDefault(); // Stops page Reload
	  var item = new FormData(document.querySelector('#item')); // object containing the FormData
	  console.log(item);
	  $.ajax({
	...
	var updateListItem = function updateListItem(id, dataIn, onSuccess, onFailure) {
	  $.ajax({
	    url: env.envVars.url + 'items/' + id,
	    type: 'PATCH',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<option >Select a list</option>\n"
	    + ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda(((stack1 = (depth0 != null ? depth0.lists : depth0)) != null ? stack1.lists : stack1), depth0),{"name":"lists.lists","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var grabListId = function grabListId() {
	...
	var bindDelete = function bindDelete() {
	  ...
	  var deleteButton = $(this).find('button.btn-warning')[0];
	  $(deleteButton).on('click', function () {
	    api.deleteItem(taskId, function () {
	      var listId = $('#sel-list').val();
	      refreshItems(listId);
	    });
	  });

	  var editButton = $(this).find('button.btn-info')[0];
	  $(editButton).on('click', function () {
	    //console.log($(this).data());     // The jquery Way
	    console.log('edit Bind', taskId); // The DOM Way
	    console.log($(this));

	    var listItem = $(this).parent('.pull-right'); //.parent('.list-group-item');
	    var inputField = $('<input name="item[todo]" type="text" placeholder="Press Enter To Submit" class="remove-field">');
	    ...
	    inputField.keypress(function (e) {
	      ...
	      if (e.which == 13) {
	        var _ret = function () {
	          _this.remove('input.remove-field');
	          var data = $(_this).val();
	...
	var refreshItems = function refreshItems() {
	  ...
	  api.getItems(listId, function (items) {
	    var itemsTemplate = __webpack_require__(30);
	    $('.items').empty().append(itemsTemplate({ items: items }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <div class=\"list-group\">\n      <div class=\"list-group-item clearfix\" data-task-id='"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "'>\n        "
	    + alias2(alias1((depth0 != null ? depth0.todo : depth0), depth0))
	    + "\n        <span class=\"pull-right\">\n          <button class=\"btn btn-xs btn-info\">\n            <span class=\"glyphicons glyphicons-pencil\">EDIT</span>\n          </button>\n          <button class=\"btn btn-xs btn-warning\">\n            <span class=\"glyphicon glyphicon-trash\"></span>\n          </button>\n        </span>\n      </div>\n    </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda(((stack1 = (depth0 != null ? depth0.items : depth0)) != null ? stack1.list_item : stack1), depth0),{"name":"items.list_item","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"container-fluid\">\n  <!-- Brand and toggle get grouped for better mobile display -->\n  <div class=\"navbar-header\">\n    <a class=\"navbar-brand\" href=\"#\">Welcome to ToDos!</a>\n  </div>\n  <!-- Collect the nav links, forms, and other content for toggling -->\n    <ul class=\"nav navbar-nav navbar-right\">\n      <button type=\"button\" data-toggle=\"modal\" data-target=\"#myModalRegister\" class=\"btn btn-primary\">Register</button>\n      <button type=\"button\" data-toggle=\"modal\" data-target=\"#myModal\" class=\"btn btn-primary\">Login</button>\n      <button type=\"button\" data-toggle=\"modal\" data-target=\"#myModalLogOut\" class=\"btn btn-primary\">Log Out</button>\n      <div class=\"btn-group\" role=\"group\" aria-label=\"groung\">\n      </div>\n      <button type=\"button\" data-toggle=\"modal\" data-target=\"#myModalChangePassword\" class=\"btn btn-primary\">Change Password</button>\n    </ul>\n</div>\n<!-- /.container-fluid -->\n";
	},"useData":true});
